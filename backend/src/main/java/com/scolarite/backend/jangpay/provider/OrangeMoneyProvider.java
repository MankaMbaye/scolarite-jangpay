 ...
 * {@code app.payments.orange-money.*} configuration once real merchant credentials exist.
 */
@Component
public class OrangeMoneyProvider implements PaymentProvider {

    private static final String NOT_CONFIGURED =
            "Orange Money integration is not configured. Set app.payments.orange-money.* and switch app.payments.mode to 'live' to enable it.";
